    ...
    return (
        <Box sx={{
            ...
            <Box sx={{ width: { sm: "42%", xs: "90%" }, textAlign: "center" }}>
                <Typography variant="h4" sx={{ mb: 2, fontSize: { xs: "1.5rem", sm: "2rem" } }}>Registration</Typography>
            </Box>
            <Box sx={{ width: { sm: "42%", xs: "90%" }, textAlign: "center" }}>
                <form>
                    <TextField
                    ...
                    <FormControlLabel
                        ...
                        sx={{ mt: 2, color: "#787775", fontSize: { xs: "0.8rem", sm: "1rem" } }}
                    />
                    <Button
                        type="submit"
                        variant="contained"
...
//         if (
//             name && idNumber && futsalName && address && dayRate &&
//             nightRate && capacity && length && width && specification &&
//             fileName && agreeTerms
//         ) {
...
//                             sx={{ fontSize: { xs: "0.8rem", sm: "1rem" }, marginRight: { sm: 2, xs: 0 } }}
//                         />
//                         <TextField
//                             fullWidth
//                             placeholder="Per Hour Rate (Night)"
